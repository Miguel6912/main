...
const DAY_1: DayDefinition = {
  ...
  lessonBlocks: [
    ...
    },
    {
      ...
      kind: 'EXPLANATION',
      text:
        "Three small words carry a lot of weight: \"oui\"/\"non\" answer almost any yes/no question, and \"excusez-moi\" both apologizes and gets someone's attention — useful the moment anything goes slightly wrong.",
...
const WEEK1_REST: DayDefinition[] = [
  shellDay({ dayNumber: 2, title: 'Express What Matters', week: 1, capability: 'Say what you need, want, or feel.' }),
  shellDay({ dayNumber: 3, title: 'Take Control With Questions', week: 1, capability: 'Ask the questions that keep an interaction moving.' }),
  shellDay({ dayNumber: 4, title: 'Stay in French When It Breaks', week: 1, capability: 'Recover from a misunderstanding without switching to English.' }),
  shellDay({ dayNumber: 5, title: 'Turn Sentences Into Thoughts', week: 1, capability: 'Link ideas into a fuller thought.' }),
  shellDay({ dayNumber: 6, title: 'Control Your World', week: 1, capability: 'Talk about possessions, people, and surroundings.' }),
  shellDay({ dayNumber: 7, title: 'Make Plans', week: 1, capability: 'Propose and agree on a plan.', fieldTestId: 'field-test-week-1' }),
];

const WEEK2: DayDefinition[] = [
  shellDay({ dayNumber: 8, title: 'Find Your Way Through a Place', week: 2, capability: 'Navigate a physical space and ask for directions.' }),
  shellDay({ dayNumber: 9, title: 'Describe What You Cannot Name', week: 2, capability: 'Describe around a gap in vocabulary.' }),
  shellDay({ dayNumber: 10, title: 'Make Yourself Precise', week: 2, capability: 'Add precision to a description or request.' }),
  shellDay({ dayNumber: 11, title: 'Talk About What Happened', week: 2, capability: 'Narrate a recent event in the past.' }),
  shellDay({ dayNumber: 12, title: "Talk About Where You've Been", week: 2, capability: 'Describe past experience and travel.' }),
  shellDay({ dayNumber: 13, title: 'Explain Your Normal Life', week: 2, capability: 'Describe habitual routines.' }),
  shellDay({ dayNumber: 14, title: 'Choose, Compare and Recommend', week: 2, capability: 'Compare options and make a recommendation.', fieldTestId: 'field-test-week-2' }),
];

const WEEK3: DayDefinition[] = [
  shellDay({ dayNumber: 15, title: 'Keep a Conversation Alive', week: 3, capability: 'Sustain a conversation past the first exchange.' }),
  shellDay({ dayNumber: 16, title: 'React Like a Human', week: 3, capability: 'Produce natural reactions and interjections.' }),
  shellDay({ dayNumber: 17, title: 'Turn Conversation Into Social Life', week: 3, capability: 'Move from talk to a social invitation or plan.' }),
  shellDay({ dayNumber: 18, title: 'Have an Opinion', week: 3, capability: 'State and mildly defend an opinion.' }),
  shellDay({ dayNumber: 19, title: 'Tell a Story Worth Hearing', week: 3, capability: 'Narrate a short story with shape.' }),
  shellDay({ dayNumber: 20, title: 'Recognise the French People Actually Speak', week: 3, capability: 'Recognise casual/connected spoken French.' }),
  shellDay({ dayNumber: 21, title: 'Join the Conversation', week: 3, capability: 'Enter and contribute to a group conversation.', fieldTestId: 'field-test-week-3' }),
];

const WEEK4: DayDefinition[] = [
  shellDay({ dayNumber: 22, title: 'Solve a Problem', week: 4, capability: 'Work through an unexpected problem in French.' }),
  shellDay({ dayNumber: 23, title: 'Survive Without Seeing the Other Person', week: 4, capability: 'Handle a phone-only interaction.' }),
  shellDay({ dayNumber: 24, title: 'Navigate Systems and Paperwork', week: 4, capability: 'Handle forms, bureaucracy, and official requests.' }),
  shellDay({ dayNumber: 25, title: 'Explain What Is Wrong With You', week: 4, capability: 'Describe a health complaint.' }),
  shellDay({ dayNumber: 26, title: 'Explain What You Do', week: 4, capability: 'Describe your work/studies in conversation.' }),
  shellDay({ dayNumber: 27, title: 'Handle Friction Without Losing the Conversation', week: 4, capability: 'Manage disagreement or friction without shutting down.' }),
  shellDay({ dayNumber: 28, title: 'Hear Through the Noise', week: 4, capability: 'Comprehend speech under real-world noise.' }),
  shellDay({ dayNumber: 29, title: 'Say What You Mean Without Knowing the Words', week: 4, capability: 'Circumlocute around missing vocabulary.' }),
  shellDay({ dayNumber: 30, title: 'Live Here', week: 4, capability: 'Sustain an independent day-in-the-life interaction chain.', fieldTestId: 'field-test-final' }),
];
